...
%% Sample test grid
GRID = [(0:95)' zeros(96,1) zeros(96,1) (0.05:0.01:1)'];
% GRID = csvread('../testCase/inletPatchFaceCentres');
...
%% HDF5 file name to store simulated data
hdf5File = 'inhomo_turb_validation.h5';
